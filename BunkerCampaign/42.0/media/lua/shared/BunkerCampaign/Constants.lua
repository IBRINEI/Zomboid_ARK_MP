...
Constants.CURRENT_STATE_VERSION = 8
...
Constants.HEATING = {
    ...
    MANUAL_BYPASS_OUTPUT_MULTIPLIER = 0.25,
    DEGRADED_COMPONENT_OUTPUT_MULTIPLIER = 0.65,
    TEMPORARY_REPAIR_WEAR_MULTIPLIER = 4,
    FAILURE_COOLDOWN_HOURS = 6,
    MAX_ACTIVE_FAILURES = 2,
    MAX_ACTIVE_MAJOR_FAILURES = 1,
    BASE_FAILURE_CHANCE_PER_MINUTE = 0.000015,
    MAX_FAILURE_CHANCE_PER_MINUTE = 0.0005,
    COMPONENT_INTERACTION_DISTANCE = 2.5,
}
