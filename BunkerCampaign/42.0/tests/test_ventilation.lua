...
assert(migrated.version == 3, "migration must set state version")
...
assert(ventilation.co2 > 400, "CO2 must rise while ventilation is disabled")
...
BunkerCampaign.VentilationSimulation.update(ventilation, 10)
assertNear(ventilation.co2, 400, 0.001, "CO2 must not fall below baseline")
